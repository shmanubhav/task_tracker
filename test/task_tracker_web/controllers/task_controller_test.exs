defmodule TaskTrackerWeb.TaskControllerTest do
  ...
  @create_attrs %{complete: true, description: "some description", timeTaken: 42, title: "some title"}
  @update_attrs %{complete: false, description: "some updated description", timeTaken: 43, title: "some updated title"}
  @invalid_attrs %{complete: nil, description: nil, timeTaken: nil, title: nil}
